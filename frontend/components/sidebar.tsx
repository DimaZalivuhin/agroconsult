...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile-only backdrop. Tap to close. Desktop never shows it. */}
      <div
        className={cn(
      ...
      <aside
        className={cn(
          ...
          // Desktop: identical to before — sticky column, no transform
          "md:static md:translate-x-0 md:h-screen md:sticky md:top-0 md:w-72 md:shrink-0 md:z-auto",
        )}
      >
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className={cn(
                          "p-0.5 rounded hover:bg-background transition-opacity",
