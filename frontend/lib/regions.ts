// Справочник субъектов РФ по ОКАТО-первой ступени.
// Используется в форме профиля и для фильтрации мер господдержки по регионам.
...
export const REGIONS: Region[] = [
  ...
  { code: "92", name: "Донецкая Народная Республика" },
  { code: "93", name: "Луганская Народная Республика" },
  { code: "94", name: "Запорожская область" },
  { code: "95", name: "Херсонская область" },
];

export function findRegionByCode(code: string | null | undefined): Region | undefined {
